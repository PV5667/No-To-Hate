...
permuteT = timeit.Timer(permute).timeit(number=num)/num

# input("What is your tweet?\n")
tweet = "TAWOHTOAHFHOAynr921yt-er 12974t19274t [oquhfd y9w7etr b9['1']]"


def censor(tweet = "TAWOHTOAHFHOAynr921yt-er 12974t19274t [oquhfd y9w7etr b9['1']]"):
...
censorT = timeit.Timer(censor).timeit(number=num)/num
